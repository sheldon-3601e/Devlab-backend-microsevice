...
import com.sheldon.devlabbackendquestionservice.mapper.QuestionMapper;
...
import devlabbackendmodel.dto.question.QuestionQueryRequest;
...
import devlabbackendmodel.vo.QuestionEditVO;
import devlabbackendmodel.vo.QuestionVO;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (StringUtils.isNotBlank(judgeCase) && judgeCase.length() > 8192) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "判题实例过长");
        }
