package com.sheldon.devlabbackendteamservice.service.impl;
...
import com.sheldon.devlabbackendcommon.common.DeleteRequest;
...
import com.sheldon.devlabbackendteamservice.mapper.TeamMapper;
import com.sheldon.devlabbackendteamservice.mapper.UserTeamMapper;
import com.sheldon.devlabbackendteamservice.service.TeamService;
import com.sheldon.devlabbackendteamservice.service.UserTeamService;
import devlabbackendmodel.dto.team.TeamJoinRequest;
import devlabbackendmodel.dto.team.TeamQueryRequest;
import devlabbackendmodel.dto.team.TeamQuitRequest;
import devlabbackendmodel.entity.Team;
import devlabbackendmodel.entity.User;
import devlabbackendmodel.entity.UserTeam;
import devlabbackendmodel.enums.TeamStatusEnum;
import devlabbackendmodel.enums.UserRoleEnum;
import devlabbackendmodel.vo.TeamUserVO;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    public List<TeamUserVO> getTeamUserVO(List<Team> teams) {
        ...
        return teams.stream().map(team -> {
            TeamUserVO teamUserVO = new TeamUserVO();
            BeanUtils.copyProperties(team, teamUserVO);
            User user = userFeignClient.getById(team.getUserId());
